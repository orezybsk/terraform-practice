...
###Add Transform chap8
masked_dyF = Map.apply(frame=dropnullfields3, f=mask)
...
datasink4 = glueContext.write_dynamic_frame.from_options(frame = masked_dyF, connection_type = "s3", connection_options = {"path": "s3://glue-job-sample-bucket/output_with_partition", "partitionKeys": ['review_date']}, format = "parquet", transformation_ctx = "datasink4")
job.commit()
